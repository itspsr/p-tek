...
export default function NewsCard({ article, minimal = false }) {
    ...
    return (
        <Link
            href={`/articles/${article.id}`} // MUST NOT ENCODE
        ...
        >
            ...
            <div className={`relative ${minimal ? "h-32" : "h-48"} w-full overflow-hidden`}>
                <Image
                    ...
                    unoptimized   // REQUIRED FOR RENDER.COM
                />
            ...
            <div className="p-4 space-y-3">
                ...
                {/* TITLE */}
                <h3 className={`font-semibold text-gray-100 group-hover:text-ptek-blue transition-colors 
