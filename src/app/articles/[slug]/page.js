...
import { getAllNews, formatDate, sanitizeItem } from "../../../lib/rss";
...
export async function generateMetadata({ params }) {
    const articleRaw = await getArticle(params.slug);
    const article = articleRaw ? sanitizeItem(articleRaw) : null;
